...
In a web browser go to:  http://localhost:8080/Debugging_Struts2_Mvn/index.action.

You should see a web page with Welcome to Struts 2 and a link for the showing the  Struts 2 configuration.
